...
const (
	...
	FileService_GetFileList_FullMethodName  = "/storage.FileService/GetFileList"
...
func (c *fileServiceClient) DownloadFile(ctx context.Context, in *FileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FileResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FileService_DownloadFileClient = grpc.ServerStreamingClient[FileResponse]
...
func (UnimplementedFileServiceServer) DownloadFile(*FileRequest, grpc.ServerStreamingServer[FileResponse]) error {
...
func _FileService_DownloadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FileServiceServer).DownloadFile(m, &grpc.GenericServerStream[FileRequest, FileResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FileService_DownloadFileServer = grpc.ServerStreamingServer[FileResponse]
